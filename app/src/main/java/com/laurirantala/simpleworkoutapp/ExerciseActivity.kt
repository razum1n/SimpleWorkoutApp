...
import com.laurirantala.simpleworkoutapp.databinding.DialogCustomBackConfirmationBinding
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.laurirantala.simpleworkoutapp/" + R.raw.press_start)
